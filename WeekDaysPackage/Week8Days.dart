...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyWeek8DaysPage(),
    );
  }
}
class MyWeek8DaysPage extends StatefulWidget {
  @override
  _MyWeek8DaysPageState createState() => _MyWeek8DaysPageState();
}
class _MyWeek8DaysPageState extends State<MyWeek8DaysPage> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
...
class Week8Day1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week8Day2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week8Day3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week8Day4 extends StatelessWidget {

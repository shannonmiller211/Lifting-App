...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyWeek6DaysPage(),
    );
  }
}
class MyWeek6DaysPage extends StatefulWidget {
  @override
  _MyWeek6DaysPageState createState() => _MyWeek6DaysPageState();
}
class _MyWeek6DaysPageState extends State<MyWeek6DaysPage> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
...
class Week6Day1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week6Day2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week6Day3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week6Day4 extends StatelessWidget {

...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyWeek7DaysPage(),
    );
  }
}
class MyWeek7DaysPage extends StatefulWidget {
  @override
  _MyWeek7DaysPageState createState() => _MyWeek7DaysPageState();
}
class _MyWeek7DaysPageState extends State<MyWeek7DaysPage> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
...
class Week7Day1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week7Day2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week7Day3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week7Day4 extends StatelessWidget {

...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyWeek2DaysPage(),
    );
  }
}
class MyWeek2DaysPage extends StatefulWidget {
  @override
  _MyWeek2DaysPageState createState() => _MyWeek2DaysPageState();
}
class _MyWeek2DaysPageState extends State<MyWeek2DaysPage> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
...
class Week2Day1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week2Day2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week2Day3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(

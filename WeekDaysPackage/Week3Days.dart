...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyWeek3DaysPage(),
    );
  }
}
class MyWeek3DaysPage extends StatefulWidget {
  @override
  _MyWeek3DaysPageState createState() => _MyWeek3DaysPageState();
}
class _MyWeek3DaysPageState extends State<MyWeek3DaysPage> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
...
class Week3Day1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week3Day2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week3Day3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class Week3Day4 extends StatelessWidget {
